...
public class XEngineCaptcha extends ListImageCaptchaEngine{
	/** 图片宽度 */
	...
	private static final String CHAR_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopqrstuvwsyz";// 随机字符
	private static final String BACKGROUND_IMAGE_PATH = "/com/programs/captcha";// 随机背景图片路径
	/**
	 * 随机字体
	 */
